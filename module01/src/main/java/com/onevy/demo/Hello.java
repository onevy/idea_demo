...
public class Hello {
    ...
    public static void main(String[] args) {
        ...
        Executor executor = new ThreadPoolExecutor(1,2,10, TimeUnit.SECONDS,new LinkedBlockingQueue<Runnable>(10));


        String str = getString(args);

        String[] strArray = new String[]{"zhangsan", "lisi", "wanghu"};
        ...
        List<String> list = Arrays.asList("123123", "3435", "342342");
